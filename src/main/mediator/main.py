...
def setup_mediator(mediator: Mediator) -> None:
    ...
    mediator.register_command_handler(LoginCommand, LoginHandler)
    ...
    mediator.register_query_handler(GetTasksByUsernameDepartment, GetTasksByUsernameDepartmentHandler)
